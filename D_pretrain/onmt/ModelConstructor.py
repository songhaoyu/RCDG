...
def make_discriminitor(opt, embeddings, dsc_dict):
    """
    Various decoder dispatcher function.
    Args:
        opt: the option in current environment.
...
def make_nli_discriminitor(opt, embeddings, dsc_dict):
...
def make_base_model(model_opt, fields, gpu, checkpoint=None, d_checkpoint=None, nli_checkpoint=None):
    """
    Args:
