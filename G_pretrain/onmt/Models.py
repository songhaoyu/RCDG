...
class NMTModel(nn.Module):
    ...
    """
    def __init__(self, encoder, decoder, ref_encoder, multigpu=False):
        self.multigpu = multigpu
        super(NMTModel, self).__init__()
        self.encoder = encoder
        self.decoder = decoder

    def forward(self, src, tgt, ref, lengths, dec_state=None):
    ...
    def sample(self, batch_size, seq_len, prefix, init_state, context, context_lengths, bos_idx):
        """
        Args:
            prefix: without bos
        """
    ...
    def infer(self, ref_context, ref_lengths, seq_len, init_state, context, context_lengths, bos_idx, sample=False):
        """
        Args:
            prefix: without bos
        """
